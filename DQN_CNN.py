...
def get_screen():
    ...
    screen = resize(screen).unsqueeze(0).type(torch.FloatTensor)
    return screen
dqn = DQN()
...
for i_episode in range(2001):
    ...
    # print(last_screen,current_screen)
    # exit()
    ...
    while True:
        ...
        if not done:
            ...
            break
        dqn.record_transition(state, action, reward, next_state)
